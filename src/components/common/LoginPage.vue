   ...
   <div class="wrapper">
    ...
    <div class="login-wrapper">
        <div class="login-selectBox">
            <select class="login-selectBox lang-select" name="" id="" >
        ...
        <div class="account-container login-box">
            ...
            <div class="account-box account">
                ...
                <label for="loginId">
                    <span>ID</span>
                    <br>
                    <input type="text" class="loginId" placeholder="ID">
                </label>
            </div>
            <div class="account-box pw">
                ...
                <label for="loginPw">
                    <span>Password</span>
                    <br>
                    <input type="password" class="loginPw" placeholder="password">
                </label>
            </div>
        ...
        <div class="account-container login-btn-box">
                <button class="custom-btn login-btn">
                    <span>Login</span>
                </button>
...
export default {
    mounted(){
        $(".login-main-wrapper").ripples({
            resolution: 346, // 렌더링 값이 클수록 잔물결 효과가 느리게 전파
...
<style>
    input:focus {
        outline:1px solid #74aad6;
        box-shadow:0 0 10px #7ebbec;
    }
    #wrapper{
        width: 100%;
        height: 100%;
    ...
    .login-btn{
        ...
        box-shadow:inset 2px 2px 2px 0px rgba(255, 255, 255, 0.555),
